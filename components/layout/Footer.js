...
const Footer = () => {
  return (
    <div className="main">
      <div className="newsletter mb-15 mt-25 wow animate__animated animate__fadeIn">
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="position-relative newsletter-inner">
                ...
                <img src="/assets/imgs/banner/banner-22.png" alt="newsletter" />
              </div>
            </div>
          </div>
        </div>
              ...
              >
                <div className="logo mb-30">
                  <Link href="/">
                    <a>
                      <img
                        src="/assets/imgs/theme/400JpgdpiLogo.jpg"
                        alt="logo"
                      />
                    </a>
                  </Link>
                ...
                <ul className="contact-infor">
                  <li>
                    <img
                      ...
                      alt=""
                    />
                    <strong> Address: </strong> <span>XXXXXXXXXXX, India</span>
                  </li>
                  <li>
                    <img
        ...
        <div className="row align-items-center">
          ...
          <div className="col-xl-3 col-lg-6 col-md-6">
            <p className="font-sm mb-0">
              &copy; 2022,{" "}
              <strong className="text-brand">@DigitalStores.in</strong>
              <br />
              All rights reserved
            </p>
          </div>
          <div className="col-xl-5 col-lg-6 text-center d-none d-xl-block">
            <div className="hotline d-lg-inline-flex mr-30">
              ...
              />
              <p className="ps-2">
                +91-888888888<span>Working 8:00 - 22:00</span>
              </p>
            </div>
            <div className="hotline d-lg-inline-flex">
              ...
              />
              <p className="ps-2">
                +91-888888888<span>24/7 Support Center</span>
              </p>
            </div>
          </div>
