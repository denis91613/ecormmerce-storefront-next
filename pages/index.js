...
export default function Home() {
  const [selFea, setSelFea] = useState(0);
  ...
  return (
    <>
      ...
      <Layout noBreadcrumb="d-none" headerStyle="header-style-1">
        <section className="container home-slider position-relative pt-50">
          <Intro1 />
        </section>
              ...
              <div className="title">
                ...
                <ul className="list-inline nav nav-tabs links">
                  <li className="list-inline-item nav-item">
                    <a
                      className={selFea === 0 ? "nav-link active" : "nav-link"}
                      onClick={() => setSelFea(0)}
                    >
                      All
                    </a>
                  ...
                  <li className="list-inline-item nav-item">
                    <a
                      className={selFea === 1 ? "nav-link active" : "nav-link"}
                      onClick={() => setSelFea(1)}
                    >
                      Cake & Milk
                    </a>
                  ...
                  <li className="list-inline-item nav-item">
                    <a
                      className={selFea === 2 ? "nav-link active" : "nav-link"}
                      onClick={() => setSelFea(2)}
                    >
                      Coffes & Teas
                    </a>
                  ...
                  <li className="list-inline-item nav-item">
                    <a
                      className={selFea === 3 ? "nav-link active" : "nav-link"}
                      onClick={() => setSelFea(3)}
                    >
                      Pet Foods
                    </a>
                  ...
                  <li className="list-inline-item nav-item">
                    <a
                      className={selFea === 4 ? "nav-link active" : "nav-link"}
                      onClick={() => setSelFea(4)}
                    >
                      Vegetables
                    </a>
        ...
        {/* <section className="deals section-padding">
          <div className="container">
            <div className="row">
              <div className="col-lg-3 deal-co">
                <Deals1 />
              </div>
              <div className="col-lg-3 deal-co">
                <Deals1 />
